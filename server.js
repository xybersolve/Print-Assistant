...
//environ = (process.env.NODE_ENV === 'development') ? 'development':'production';
rootPath = cfg[environ].rootPath;
console.log('**********************************************************');
...
app.use(express.static(__dirname + rootPath, {maxAge:oneDay}));
app.use(favicon(__dirname + rootPath + '/favicon.ico'));
...
app.use('/api/images',   require('./server/routes/images')   (imageProvider)        );
